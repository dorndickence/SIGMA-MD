...
global.owner = process.env.OWNER_NUMBER  || '254113907065' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "254113907065" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"D♥︎❚❚♥︎N",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'Dorn-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Dorn Dickence`, // ADD YOUR NAME
